...
<tool_call>{"tool":"replace_guidelines","id":"guidelines-1","authorNote":"Translated author note..."}</tool_call>
...
<tool_call>{"tool":"patch_guidelines","id":"guidelines-1","field":"authorNote","old":"wrong","new":"correct"}</tool_call>
