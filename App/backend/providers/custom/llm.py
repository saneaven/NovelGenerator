...
from ..claude.llm import ClaudeProvider
from ..shared.contracts import ProviderEvent
from ..openai.llm import OpenAIResponsesProvider
...
class _CustomClaudeProvider(ClaudeProvider):
    ...
    def _build_client(self) -> AsyncAnthropic:
        ...
        default_headers = resolve_and_filter_headers(self._additional_headers)
        if default_headers:
...
class CustomProvider(AsyncOpenAIProvider):
    ...
    def default_headers(self) -> Dict[str, str]:
        return resolve_and_filter_headers(self._additional_headers)
