...
RUN_CANCELABLE_STATUSES = {"queued", "running", "waiting", "processing", "ready", "paused", "error"}
THREAD_DELETE_PRE_CLEANUP_STATUSES = {"running", "waiting", "processing", "ready", "paused", "error"}
