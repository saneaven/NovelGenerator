...
_COLOR = {"type": ["string", "null"], "description": "Track color as an oklch() string or #hex. Omit this so a color is assigned automatically; only set it when the user explicitly requests a specific color."}
