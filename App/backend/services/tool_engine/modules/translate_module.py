        ...
        return filter_allowed_specs(
            ...
            [
                ...
                ToolSpec(
                    ...
                    parameters=obj_schema({"id": _ID, "name": {"type": "string"}, "description": {"type": "string"}, "content": {"type": "string", "description": "Translated rich text content (markdown)"}}, ["id", "name", "description"]),
                    auto_approve_category="translate",
                ),
                ToolSpec(
