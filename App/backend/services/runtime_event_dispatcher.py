...
class RuntimeEventDispatcher:
    ...
    async def emit_runtime_event(
        ...
        *,
        ...
        if not user_id_str or not project_id_str or not thread_id_str:
            raise ValueError("user_id, project_id, and thread_id are required")
        ...
        await self._bus.publish(f"user:{user_id_str}", event)
        return event
