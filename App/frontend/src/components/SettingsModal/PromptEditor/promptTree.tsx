...
export const PROMPT_TREE: PromptNode[] = [
    ...
    children: [
      {
        ...
        label: 'Story Entities',
        type: 'prompt',
        taskType: 'translation',
        taskSubtype: 'object',
        description: 'Scenario for translating project objects',
        defaultExpanded: true,
  ...
  },
  {
    ...
    children: [
      ...
      {
        id: 'editAssistant-projectData',
        label: 'Project Data',
        type: 'prompt',
        taskType: 'editAssistant',
        taskSubtype: 'projectData',
        description: 'Scenario for editing basic info, guidelines, or a story entity',
        defaultExpanded: true,
        children: makeViewChildren('editAssistant-projectData', 'editAssistant', 'projectData'),
      },
      {
        id: 'editAssistant-outline',
        label: 'Outline',
        type: 'prompt',
        taskType: 'editAssistant',
        taskSubtype: 'outline',
        description: 'Scenario for editing outline structures',
        defaultExpanded: true,
        children: makeViewChildren('editAssistant-outline', 'editAssistant', 'outline'),
      },
    ],
  },
  {
