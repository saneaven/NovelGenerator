...
export const Clock: React.FC<IconProps> = ({
  ...
  >
        <g id="Iconly/Light/Time-Circle" stroke="none" stroke-width="1.5" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round">
        <g id="Time-Circle" transform="translate(2.000000, 2.000000)" stroke={color} stroke-width={strokeWidth}>
