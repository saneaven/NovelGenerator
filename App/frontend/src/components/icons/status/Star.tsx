...
export const Star: React.FC<IconProps> = ({
  ...
  >
		    <g id="Iconly/Light/Star" stroke="none" strokeWidth={strokeWidth} fill="none" fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round">
		        <g id="Star" transform="translate(3.000000, 3.500000)" stroke={color} strokeWidth={strokeWidth}>
