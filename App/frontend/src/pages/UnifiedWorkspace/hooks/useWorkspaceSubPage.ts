...
export type SubPageType = 'story-object' | 'outline-manager' | 'novel-editor' | 'config';

const STORAGE_KEY_PREFIX = 'workspace_last_subpage_';
const DEFAULT_SUBPAGE: SubPageType = 'story-object';
const VALID_SUBPAGES: SubPageType[] = ['story-object', 'outline-manager', 'novel-editor', 'config'];
