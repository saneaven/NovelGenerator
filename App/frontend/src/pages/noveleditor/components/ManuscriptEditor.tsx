/**
 * ManuscriptEditor - TipTap-based editor for manuscripts
 *
 * Differences vs RichTextEditor:
 * - Source of truth is TipTap JSON (doc)
 * - onChange emits doc JSON, not markdown
 */
...
import { normalizeDoc, emptyDoc } from '../../../editor/manuscript/doc';
import { buildManuscriptExtensions } from '../../../editor/manuscript/extensions';
...
const ManuscriptEditor = forwardRef<ManuscriptEditorRef, ManuscriptEditorProps>(({
  initialDoc,
  onChange,
  ...
  const editor = useEditor({
    extensions: buildManuscriptExtensions({ placeholder }),
